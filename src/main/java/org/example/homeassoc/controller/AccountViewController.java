...
public class AccountViewController {
    ...
    @FXML
    private TableColumn<Account, Integer> column1;
    @FXML
    private TableColumn<Account, Integer> column2;
    @FXML
    private TableColumn<Account, Integer> column3;

    @FXML
    private TableView<Account> view;
    ...
    public void clickCreateButton() throws SQLException {
        try {
            ...
            fxmlLoader.setLocation(Main.class.getResource("CreateAccount.fxml"));
    ...
    public void clickUpdateButton() throws SQLException {
        Account selectedReceipt = view.getSelectionModel().getSelectedItem();
        ...
        if (selectedReceipt != null) {
            ...
            st.setInt(1, selectedReceipt.getAccount_ID());
    ...
    public void clickDeleteAllButton() throws SQLException {
        ...
        if (selectedReceipt != null) {
            String sql = "DELETE FROM public.\"Account\"";
            Connection connection = DatabaseConnection.getInstance();
    ...
    public void initialize() throws SQLException {
        ...
        column1.setCellValueFactory(new PropertyValueFactory<Account, Integer>("Account_ID"));
        column2.setCellValueFactory(new PropertyValueFactory<Account, Integer>("Sum"));
        column3.setCellValueFactory(new PropertyValueFactory<Account, Integer>("Apartment_Apartment_ID"));
        view.setItems(getAll());
    }



    ObservableList<Account> getAll() throws SQLException {
        Connection conn = DatabaseConnection.getInstance();

        Statement st = conn.createStatement();
        ResultSet rs = st.executeQuery("SELECT * FROM \"Account\"");
        ObservableList<Account> persons = FXCollections.observableArrayList();

        while (rs.next()) {
            persons.add(new Account(rs.getInt(1), rs.getInt(2), rs.getInt(3)));
        }
        rs.close();
        st.close();
