...
public class ResidentViewController {
    ...
    @FXML
    private TableColumn<Resident, Integer> column1;
    @FXML
    private TableColumn<Resident, String> column2;
    @FXML
    private TableColumn<Resident, Integer> column3;

    @FXML
    private TableView<Resident> view;
    ...
    public void clickCreateButton() throws SQLException {
        try {
            ...
            fxmlLoader.setLocation(Main.class.getResource("CreateResident.fxml"));
            Scene scene = new Scene(fxmlLoader.load());
            Stage stage = new Stage();
            stage.setTitle("Create Resident");
    ...
    public void clickUpdateButton() throws SQLException {
        Resident selectedReceipt = view.getSelectionModel().getSelectedItem();

        if (selectedReceipt != null) {
            String sql = "DELETE FROM public.\"Resident\" WHERE \"Resident_ID\" = ?";
            Connection connection = DatabaseConnection.getInstance();

            PreparedStatement st = connection.prepareStatement(sql);
            st.setInt(1, selectedReceipt.getId());
    ...
    public void clickDeleteAllButton() throws SQLException {
        ...
        if (selectedReceipt != null) {
            String sql = "DELETE FROM public.\"Resident\"";
            Connection connection = DatabaseConnection.getInstance();
    ...
    public void initialize() throws SQLException {
        ...
        column1.setCellValueFactory(new PropertyValueFactory<Resident, Integer>("id"));
        column2.setCellValueFactory(new PropertyValueFactory<Resident, String>("name"));
        column3.setCellValueFactory(new PropertyValueFactory<Resident, Integer>("apparts"));
        view.setItems(getAll());
    }



    ObservableList<Resident> getAll() throws SQLException {
