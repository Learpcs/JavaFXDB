...
public class ReceiptForServiceController {
    ...
    public void clickCreateButton() throws SQLException {
        try {
            ...
            fxmlLoader.setLocation(Main.class.getResource("CreateReceiptForService.fxml"));
    ...
    public void clickUpdateButton() throws SQLException {
        ReceiptForService selectedReceipt = receiptForServiceView.getSelectionModel().getSelectedItem();

        if (selectedReceipt != null) {
            String sql = "DELETE FROM public.\"Receipt for service\" WHERE \"Receipt_ID\" = ?";
            Connection connection = DatabaseConnection.getInstance();

            PreparedStatement st = connection.prepareStatement(sql);
            st.setInt(1, selectedReceipt.getReceipt_ID());
    ...
    public void clickDeleteAllButton() throws SQLException {
        ...
        if (selectedReceipt != null) {
            String sql = "DELETE FROM public.\"Receipt for service\"";
            Connection connection = DatabaseConnection.getInstance();
